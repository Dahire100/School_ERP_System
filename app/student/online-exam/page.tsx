...
const studentNavItems = [
  ...
  { label: "Online Exam", href: "/student/online-exam", icon: <BarChart3 size={20} /> },
]
      ...
      <div className="flex">
        ...
        <main className="flex-1 md:ml-64 p-4 md:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">Take assigned tests and quizzes</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-3">
                  <Button className="w-full">View Available</Button>
